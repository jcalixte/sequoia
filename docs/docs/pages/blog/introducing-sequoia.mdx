...
<div class="relative w-full" style={{paddingBottom: "73.17%"}}>
<iframe
...
Install Sequoia today and check out the [quickstart guide](/quickstart) to publish your content into the ATmosphere 🌳 
